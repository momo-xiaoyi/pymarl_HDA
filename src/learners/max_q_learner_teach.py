...
class MAXQLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        #self.optimiser = RMSprop(params=self.params, lr=args.lr/args.lr_time, alpha=args.optim_alpha, eps=args.optim_eps)
        #self.optimiser2 = RMSprop(params=self.params, lr=args.lr, alpha=args.optim_alpha, eps=args.optim_eps)
